...
- Reforge, ProfitWell, and other practitioners publish strong empirical guidance on pricing; this skill is opinionated about the structure, not about the specific numbers. Numbers are context-dependent and need primary research per product.
...
- `references/pricing-experimentation-guide.md` — A/B test design for pricing, mix-shift detection, readout windows
- `references/packaging-frameworks.md` — Tier vs usage vs hybrid, Ramanujam packaging principles
- `assets/pricing_prd_template.md` — 13-section pricing PRD template
- `assets/pricing_experiment_design.md` — A/B test design worksheet
- `assets/pricing_page_checklist.md` — UX review checklist
