...
name: copywriting
description: >
  Write persuasive marketing copy for homepages, landing, pricing, feature, and
  product pages using headline formulas, CTA frameworks, and objection handling.
  Use when writing page copy, improving headlines, crafting CTAs, or conversion
  copy.
license: MIT
metadata:
  version: 1.0.0
