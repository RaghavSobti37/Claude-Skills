...
282 production-ready skills across 15 domains, each with Python CLI tools, reference guides, and templates.

## Domains at a Glance

| Domain | Skills | Tools | Page |
|---|:---:|:---:|---|
| **★ Project Management** (most-used) | **42** | **68+** | **[View all](project-management.md)** |
